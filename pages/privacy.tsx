      ...
      <main className="max-md:pt-2 md:pt-9 pb-20 px-9 max-w-[1000px] w-full flex flex-1 flex-col items-center justify-center">
        <article id="privacy">
          <section id="contentheader">
            <h1 className="mb-8">PAAFL.com Privacy Policy</h1>
            <ButtonInternal href="" title="Go to the home/index page of PAAFL.com"><p>Go to Homepage</p></ButtonInternal>
          </section>

          <section id="privacypolicy" className="max-w-[1000px] text-left">
            <h2 id="overview">Privacy Policy Overview</h2>
            <p>It is the policy of Pomeroy Appraisal Associates of Florida Inc to respect your privacy regarding any information we may collect while viewing/using our website. This privacy policy applies to <LinkInternal href="" title="PAAFL.com">PAAFL.com</LinkInternal> (hereinafter, “the website”, “our website”). Pomeroy Appraisal Associates of Florida Inc respects your privacy and is committed to protecting personally identifiable information you may provide Pomeroy Appraisal Associates of Florida Inc through the website. We have adopted this privacy policy to explain what information may be collected in the website, how we uses this information, and under what circumstances we may disclose the information to third parties. This privacy policy applies only to information we collect through the website and does not apply to the collection of information from other sources.</p>
            ...
            <p>Our website may contain links to external sites that are not operated by Pomeroy Appraisal Associates of Florida Inc. If you click on a third party link, you will be directed to that third party’s site. We strongly advises you to review the privacy policy and terms and conditions of every site you visit.</p>
            ...
            <p>If Pomeroy Appraisal Associates of Florida Inc, or a substantially amount of assets owned by Pomeroy Appraisal Associates of Florida Inc, were acquired, or in the unlikely event that Pomeroy Appraisal Associates of Florida Inc goes out of business, or enters bankruptcy, user information would be one of the assets that is transferred or acquired by a third party. You acknowledge that such transfers may occur, and that any acquirer of Pomeroy Appraisal Associates of Florida Inc may continue to use your personal information as set forth in this policy.</p>

            <h2 id="entire-agreement">Entire Agreement</h2>
            <p>The privacy policy is the sole and entire agreement between you and Pomeroy Appraisal Associates of Florida Inc regarding the Services and supersede all prior and contemporaneous understandings, agreements, representations, and warranties, both written and oral, regarding their subject matter.</p>
            ...
            <p><em>This privacy policy was last updated on September 7, 2024. Visit the <LinkExternal href="https://github.com/derek-perry/paafl.com" title="View the repository for PAAFL.com at github.com/derek-perry/paafl.com">website files on GitHub</LinkExternal> for version history.</em></p>

            <h2 id="contact-info">Contact Information</h2>
            <p>If you have any questions about this privacy policy, please contact Pomeroy Appraisal Associates of Florida Inc via email at <LinkExternal href="mailto:info@paafl.com" title="Contact Pomeroy Appraisal Associates of Florida Inc via Email at Info@PAAFL.com">Info@PAAFL.com</LinkExternal></p>
          </section>
        </article>
      </main>
