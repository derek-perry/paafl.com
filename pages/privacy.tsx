      ...
      <main className="max-md:pt-2 md:pt-9 pb-20 px-9 max-w-[1000px] w-full flex flex-1 flex-col items-center justify-center">
        <article id="privacy">
          ...
          <section id="privacypolicy" className="max-w-[1000px] text-left">
            ...
            <p><em>This privacy policy was last updated on September 7, 2024. Visit the <LinkExternal href={GitHub} title="View the GitHub repository for this website">website files on GitHub</LinkExternal> for version history.</em></p>

            <h2 id="contact-info">Contact Information</h2>
            <p>If you have any questions about this privacy policy, please contact {NameLongInc} via email at <LinkExternal href={"mailto:" + EmailMain} title={"Contact " + NameLongInc + " via Email at " + EmailMain}>{EmailMain}</LinkExternal></p>
          </section>
        </article>
      </main>
